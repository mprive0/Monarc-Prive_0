  ...
  return (
    <>
      ...
      {page === "restaurants" && <>
        ...
        <div className="sec"><div className="g3">{RESTAURANTS.map(r => <RestCard key={r.id} r={r} />)}</div><PartnerCTA msg="Own a luxury restaurant?" btn="List Your Restaurant" stream="restaurant" /></div>
        <Footer />
      </>}
